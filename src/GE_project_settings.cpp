...
bool ge_project_settings_load(EwProjectSettings& out, const std::string& path_utf8, std::string& out_err) {
    ...
    while (std::getline(f, line)) {
        ...
        } else if (k == "rendering.screen_proxy_scale_q16_16") {
            if (!_parse_i32(v, out.rendering.screen_proxy_scale_q16_16)) return false;
        } else if (k == "rendering.lod_boost_max_q16_16") {
            if (!_parse_i32(v, out.rendering.lod_boost_max_q16_16)) return false;
        ...
        } else if (k == "camera.near_m_q16_16") {
            if (!_parse_i32(v, out.camera.near_m_q16_16)) return false;
        } else if (k == "camera.far_m_q16_16") {
            if (!_parse_i32(v, out.camera.far_m_q16_16)) return false;
        } else if (k == "camera.focus_band_m_q16_16") {
            if (!_parse_i32(v, out.camera.focus_band_m_q16_16)) return false;
        } else if (k == "camera.near_boost_min_m_q16_16") {
            if (!_parse_i32(v, out.camera.near_boost_min_m_q16_16)) return false;
        } else if (k == "camera.near_boost_max_m_q16_16") {
            if (!_parse_i32(v, out.camera.near_boost_max_m_q16_16)) return false;
...
bool ge_project_settings_save(const EwProjectSettings& s, const std::string& path_utf8, std::string& out_err) {
    ...
    f << "rendering.screen_proxy_scale_q16_16=" << s.rendering.screen_proxy_scale_q16_16 << "\n";
    f << "rendering.lod_boost_max_q16_16=" << s.rendering.lod_boost_max_q16_16 << "\n";
    ...
    f << "camera.near_m_q16_16=" << s.camera.near_m_q16_16 << "\n";
    f << "camera.far_m_q16_16=" << s.camera.far_m_q16_16 << "\n";
    f << "camera.focus_band_m_q16_16=" << s.camera.focus_band_m_q16_16 << "\n";
    f << "camera.near_boost_min_m_q16_16=" << s.camera.near_boost_min_m_q16_16 << "\n";
    f << "camera.near_boost_max_m_q16_16=" << s.camera.near_boost_max_m_q16_16 << "\n";
