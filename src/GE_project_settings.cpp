...
bool ge_project_settings_load(EwProjectSettings& out, const std::string& path_utf8, std::string& out_err) {
    ...
    while (std::getline(f, line)) {
        ...
        } else if (k == "assets.project_asset_substrate_root_utf8") {
            out.assets.project_asset_substrate_root_utf8 = v;
        } else if (k == "assets.global_asset_cache_root_utf8") {
            out.assets.global_asset_cache_root_utf8 = v;
        } else if (k == "assets.content_index_filename_utf8") {
            out.assets.content_index_filename_utf8 = v;
        } else {
...
bool ge_project_settings_save(const EwProjectSettings& s, const std::string& path_utf8, std::string& out_err) {
    ...
    f << "assets.project_asset_substrate_root_utf8=" << s.assets.project_asset_substrate_root_utf8 << "\n";
    f << "assets.global_asset_cache_root_utf8=" << s.assets.global_asset_cache_root_utf8 << "\n";
    f << "assets.content_index_filename_utf8=" << s.assets.content_index_filename_utf8 << "\n";
    return true;
}
